import { Axiom } from 'contentlayer/generated'
...
export function AxiomItem({ axiom }: Props) {
	return (
		<Link
			className='cursor-pointer overflow-hidden relative'
			href={`/axiom/${axiom.slug}`}>

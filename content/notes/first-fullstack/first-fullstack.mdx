---
type: Note
title: 'My First Full-Stack Project ZeusConnect'
summary: 'Im proud to share my first fullstack project, ZeusConnect, an online conference application.'
...
1. Visit the ZeusConnect website [https://zeus-connect-delta.vercel.app].
2. Create a free account.
3. Start your first meeting or join one using a shared link.

## Technical Notes
- ZeusConnect is built using React.
- We welcome contributions! Check out our GitHub repository [https://github.com/hasin-codes/ZeusConnect/] 